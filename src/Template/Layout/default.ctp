...
<body id="kt_body"
    class="page-loading-enabled page-loading header-static header-mobile-fixed subheader-enabled aside-enabled aside-fixed aside-minimize-hoverable page-loading">
    ...
    $(this).closest("li").parent().parent().parent().parent().parent().parent().addClass("menu-item menu-item-submenu
    menu-item-open");
    }
    });
    });
