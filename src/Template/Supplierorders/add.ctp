...
$this->assign('title', 'Ajouter un nouveau bon de commande');
?>
<div class="row">
  <div class="col-lg-12">
    <div class="card">
      <div class="card-body p-0">
        <div class="row">
          ...
          <div class="col-xl-8">
            <div class="my-5">
              <?= $this->Form->control('supplier_id', ['class' => 'phone form-control', 'options' => $suppliers, 'label' => 'Fournisseur']) ?>
              ...
              <?php if ($productselect['products']) { ?>
                ...
                <?php foreach ($productselect['products'] as $key1 => $product): ?>
                  <tr>
                    ...
                    <?= $this->Form->control('supporderproducts.' . $product['id'] . '.productunite_id', ['type' => 'hidden', 'class' => 'form-control', 'label' => false, 'value' => $product['id']]); ?>
                    <td style="width: 50%;">
                      <?= $product['title'] ?><br>
                    </td>
                    ...
                    <td>
                      <?= $this->Form->control('supporderproducts.' . $product['id'] . '.price', ['type' => 'number', 'class' => 'form-control', 'label' => false, 'value' => $product[0]['price']]); ?>
                    </td>
                  </tr>
                <?php endforeach ?>
              <?php } ?>
